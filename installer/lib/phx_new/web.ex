defmodule Phx.New.Web do
  ...
  template :live, [
    ...
    {:eex, "phx_live/templates/layout/root.html.heex", :web, "lib/:web_app/templates/layout/root.html.heex"},
    {:eex, "phx_live/templates/layout/app.html.heex",  :web, "lib/:web_app/templates/layout/app.html.eex"},
    {:eex, "phx_live/templates/layout/live.html.heex", :web, "lib/:web_app/templates/layout/live.html.heex"},
    {:eex, "phx_web/views/layout_view.ex",             :web, "lib/:web_app/views/layout_view.ex"},
    {:eex, "phx_live/live/page_live.ex",               :web, "lib/:web_app/live/page_live.ex"},
    {:eex, "phx_web/templates/page/index.html.eex",    :web, "lib/:web_app/live/page_live.html.heex"},
    {:eex, "phx_test/views/layout_view_test.exs",      :web, "test/:web_app/views/layout_view_test.exs"},
