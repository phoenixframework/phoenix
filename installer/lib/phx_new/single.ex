defmodule Phx.New.Single do
  ...
  template :new, [
    {:eex,  "phx_single/config/config.exs.eex",           :project, "config/config.exs"},
    {:eex,  "phx_single/config/dev.exs.eex",              :project, "config/dev.exs"},
    {:eex,  "phx_single/config/prod.exs.eex",             :project, "config/prod.exs"},
    {:eex,  "phx_single/config/runtime.exs.eex",          :project, "config/runtime.exs"},
    {:eex,  "phx_single/config/test.exs.eex",             :project, "config/test.exs"},
    {:eex,  "phx_single/lib/app_name/application.ex.eex", :project, "lib/:app/application.ex"},
    {:eex,  "phx_single/lib/app_name.ex.eex",             :project, "lib/:app.ex"},
    {:eex,  "phx_web/channels/user_socket.ex.eex",        :project, "lib/:lib_web_name/channels/user_socket.ex"},
    {:keep, "phx_web/controllers",                        :project, "lib/:lib_web_name/controllers"},
    {:eex,  "phx_web/views/error_helpers.ex.eex",         :project, "lib/:lib_web_name/views/error_helpers.ex"},
    {:eex,  "phx_web/views/error_view.ex.eex",            :project, "lib/:lib_web_name/views/error_view.ex"},
    {:eex,  "phx_web/endpoint.ex.eex",                    :project, "lib/:lib_web_name/endpoint.ex"},
    {:eex,  "phx_web/router.ex.eex",                      :project, "lib/:lib_web_name/router.ex"},
    {:eex,  "phx_web/telemetry.ex.eex",                   :project, "lib/:lib_web_name/telemetry.ex"},
    {:eex,  "phx_single/lib/app_name_web.ex.eex",         :project, "lib/:lib_web_name.ex"},
    {:eex,  "phx_single/mix.exs.eex",                     :project, "mix.exs"},
    {:eex,  "phx_single/README.md",                       :project, "README.md"},
    {:eex,  "phx_single/formatter.exs.eex",               :project, ".formatter.exs"},
    {:eex,  "phx_single/gitignore",                       :project, ".gitignore"},
    {:eex,  "phx_test/support/channel_case.ex.eex",       :project, "test/support/channel_case.ex"},
    {:eex,  "phx_test/support/conn_case.ex.eex",          :project, "test/support/conn_case.ex"},
    {:eex,  "phx_single/test/test_helper.exs.eex",        :project, "test/test_helper.exs"},
    {:keep, "phx_test/channels",                          :project, "test/:lib_web_name/channels"},
    {:keep, "phx_test/controllers",                       :project, "test/:lib_web_name/controllers"},
    {:eex,  "phx_test/views/error_view_test.exs.eex",     :project, "test/:lib_web_name/views/error_view_test.exs"},
  ]

  template :gettext, [
    {:eex,  "phx_gettext/gettext.ex.eex",           :project, "lib/:lib_web_name/gettext.ex"},
  ...
  template :html, [
    {:eex, "phx_web/controllers/page_controller.ex.eex",        :project, "lib/:lib_web_name/controllers/page_controller.ex"},
    ...
    {:eex, "phx_web/views/layout_view.ex.eex",                  :project, "lib/:lib_web_name/views/layout_view.ex"},
    {:eex, "phx_web/views/page_view.ex.eex",                    :project, "lib/:lib_web_name/views/page_view.ex"},
    {:eex, "phx_test/controllers/page_controller_test.exs.eex", :project, "test/:lib_web_name/controllers/page_controller_test.exs"},
    {:eex, "phx_test/views/layout_view_test.exs.eex",           :project, "test/:lib_web_name/views/layout_view_test.exs"},
    {:eex, "phx_test/views/page_view_test.exs.eex",             :project, "test/:lib_web_name/views/page_view_test.exs"},
  ]
  ...
  template :live, [
    ...
    {:eex, "phx_web/views/layout_view.ex.eex",               :project, "lib/:lib_web_name/views/layout_view.ex"},
    {:eex, "phx_live/live/page_live.ex.eex",                     :project, "lib/:lib_web_name/live/page_live.ex"},
    {:eex, "phx_web/templates/page/index.html.eex",          :project, "lib/:lib_web_name/live/page_live.html.leex"},
    {:eex, "phx_test/views/layout_view_test.exs.eex",            :project, "test/:lib_web_name/views/layout_view_test.exs"},
    {:eex, "phx_test/live/page_live_test.exs.eex",               :project, "test/:lib_web_name/live/page_live_test.exs"},
  ]

  template :ecto, [
    {:eex,  "phx_ecto/repo.ex.eex",          :app, "lib/:app/repo.ex"},
    ...
    {:eex,  "phx_ecto/seeds.exs.eex",        :app, "priv/repo/seeds.exs"},
    {:eex,  "phx_ecto/data_case.ex.eex",     :app, "test/support/data_case.ex"},
  ]
