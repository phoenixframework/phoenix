defmodule Mix.Tasks.Phx.New.Umbrella do
  ...
  template :new, [
    ...
    {:eex,  "phx_umbrella/apps/app_name/lib/application.ex",      "apps/app_name/lib/application.ex"},
    ...
    {:eex,  "phx_umbrella/apps/app_name_web/lib/application.ex",      "apps/app_name_web/lib/application.ex"},
    {:eex,  "phx_umbrella/apps/app_name_web/lib/web.ex",              "apps/app_name_web/lib/web.ex"},
