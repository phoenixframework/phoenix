  ...
  describe "phx.gen.html" do
    ...
    test "has a passing test suite" do
      with_installer_tmp("umbrella_app_with_defaults", fn tmp_dir ->
        ...
        mix_run!(~w(phx.gen.html Blog Post posts title body:string), web_root_path)
  ...
  describe "phx.gen.json" do
    test "has no compilation or formatter warnings" do
      with_installer_tmp("umbrella_app_with_defaults", fn tmp_dir ->
        ...
        mix_run!(~w(phx.gen.json Blog Post posts title:unique body:string), web_root_path)
    ...
    test "has a passing test suite" do
      with_installer_tmp("umbrella_app_with_defaults", fn tmp_dir ->
        ...
        mix_run!(~w(phx.gen.json Blog Post posts title body:string), web_root_path)
  ...
  describe "phx.gen.live" do
    test "has no compilation or formatter warnings" do
      with_installer_tmp("umbrella_app_with_defaults", fn tmp_dir ->
        ...
        mix_run!(~w(phx.gen.live Blog Post posts title:unique body:string), web_root_path)
    ...
    test "has a passing test suite" do
      with_installer_tmp("umbrella_app_with_defaults", fn tmp_dir ->
        ...
        mix_run!(~w(phx.gen.live Blog Post posts title body:string), web_root_path)
