...
Heroku gives the ability to connect to your dyno with an iex shell if you need to make database queries for example.

- Connect to your dyno with `heroku ps:exec`
