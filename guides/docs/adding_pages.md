...
A note on hot code reloading, some editors with their automatic linters are preventing hot code reloading from working. If it's not working for you, please see the dicussion in [this issue](https://github.com/phoenixframework/phoenix/issues/1165).
