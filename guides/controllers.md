...
A step beyond this is rendering pure JSON with the [`json/2`] function. We need to pass it something that the [JSON](https://elixir.hexdocs.pm/JSON.html) module can encode, such as a map.
