...
A step beyond this is rendering pure JSON with the [`json/2`] function. We need to pass it something that the [JSON library](https://elixir.hexdocs.pm/JSON.html) can decode into JSON, such as a map.
