...
If you want a platform-as-a-service without these limitations, try [Gigalixir](gigalixir.html) or [Render](render.html). If you would rather deploy to a cloud platform, such as EC2, Google Cloud, etc, consider using `mix release`.
