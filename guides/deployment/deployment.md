...
10:50:18.732 [info] Running MyAppWeb.Endpoint with Cowboy on https://example.com
...
```console
$ PORT=4001 MIX_ENV=prod mix phx.server
10:59:19.136 [info] Running MyAppWeb.Endpoint with Cowboy on https://example.com
```
