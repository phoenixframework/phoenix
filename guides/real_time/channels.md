...
In `lib/hello_web/components/layouts/root.html.heex`, we'll replace the existing code with a container to hold our chat messages, and an input field to send them:
