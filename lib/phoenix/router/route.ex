defmodule Phoenix.Router.Route do
  ...
  The `Phoenix.Router.Route` struct. It stores:
    ...
    * `:module` - the module where the route will dispatch to
  ...
  """
  @spec build(non_neg_integer, :match | :forward, atom, String.t, String.t | nil, atom, atom, atom | nil, list(atom), map, map, map, module, boolean) :: t
  def build(line, kind, verb, path, host, plug, plug_opts, helper, pipe_through, private, assigns, metadata, module, trailing_slash?)
      when is_atom(verb) and (is_binary(host) or is_nil(host)) and
           ...
           is_boolean(trailing_slash?) and is_atom(module) do
    %Route{kind: kind, verb: verb, path: path, host: host, private: private,
           ...
           module: module, trailing_slash?: trailing_slash?}
  end
