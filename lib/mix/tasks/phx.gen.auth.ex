defmodule Mix.Tasks.Phx.Gen.Auth do
  ...
  defp files_to_be_generated(%Context{schema: schema, context_app: context_app} = context) do
    ...
    [
      ...
      {:eex, "auth.ex",
       Path.join([web_prefix, "controllers", web_path, "#{schema.singular}_auth.ex"])},
      {:eex, "auth_test.exs",
       Path.join([web_test_prefix, "controllers", web_path, "#{schema.singular}_auth_test.exs"])},
      {:eex, "confirmation_view.ex",
       Path.join([web_prefix, "views", web_path, "#{schema.singular}_confirmation_view.ex"])},
      {:eex, "confirmation_new.html.eex",
       Path.join([
         web_prefix,
         "templates",
         web_path,
      ...
      {:eex, "_menu.html.eex",
       Path.join([web_prefix, "templates", "layout", "_#{schema.singular}_menu.html.eex"])},
      {:eex, "registration_new.html.eex",
       Path.join([
         web_prefix,
         "templates",
         web_path,
      ...
      {:eex, "reset_password_edit.html.eex",
       Path.join([
         web_prefix,
         "templates",
         web_path,
      ...
      {:eex, "reset_password_new.html.eex",
       Path.join([
         web_prefix,
         "templates",
         web_path,
      ...
      {:eex, "session_controller.ex",
       Path.join([web_prefix, "controllers", web_path, "#{schema.singular}_session_controller.ex"])},
      ...
      {:eex, "session_new.html.eex",
       Path.join([web_prefix, "templates", web_path, "#{schema.singular}_session", "new.html.eex"])},
      {:eex, "settings_view.ex",
       Path.join([web_prefix, "views", web_path, "#{schema.singular}_settings_view.ex"])},
      {:eex, "settings_edit.html.eex",
       Path.join([
         web_prefix,
         "templates",
         web_path,
