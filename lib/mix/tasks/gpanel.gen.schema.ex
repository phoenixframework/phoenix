defmodule Mix.Tasks.Gpanel.Gen.Schema do
  @shortdoc "Generates an Ecto schema and migration file"

  @moduledoc """
  Generates an Ecto schema and migration.

      $ mix gpanel.gen.schema Blog.Post blog_posts title:string views:integer
  ...
  Via CLI:
      ...
      $ mix gpanel.gen.schema Blog.Post blog_posts title:string views:integer --context-app marketing
  ...
  the type makes it default to `:string`:
      ...
      $ mix gpanel.gen.schema Blog.Post blog_posts title views:integer
  ...
  referenced table:
      ...
      $ mix gpanel.gen.schema Blog.Post blog_posts title user_id:references:users
  ...
  type of the underlying array element to be given too:
      ...
      $ mix gpanel.gen.schema Blog.Post blog_posts tags:array:string

  Unique columns can be automatically generated by using:

      $ mix gpanel.gen.schema Blog.Post blog_posts title:unique unique_int:integer:unique

  Redact columns can be automatically generated by using:

      $ mix gpanel.gen.schema Accounts.Superhero superheroes secret_identity:redact password:string:redact

  Ecto.Enum fields can be generated by using:

      $ mix gpanel.gen.schema Blog.Post blog_posts title status:enum:unpublished:published:deleted
  ...
  a `--table` option may be provided. For example:
      ...
      $ mix gpanel.gen.schema Blog.Post posts --table cms_posts
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix gpanel.gen.schema must be invoked from within your *_web application root directory"
    end
  ...
  def copy_new_files(%Schema{context_app: ctx_app} = schema, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/gpanel.gen.schema", binding, files)
    ...
    if schema.migration? do
      ...
      Mix.Phoenix.copy_from paths, "priv/templates/gpanel.gen.schema", binding, [
  ...
  def raise_with_help(msg) do
    ...
    mix gpanel.gen.schema expects both a module name and
    the plural of the generated resource followed by
    any number of attributes:

        mix gpanel.gen.schema Blog.Post blog_posts title:string
    """
  end
