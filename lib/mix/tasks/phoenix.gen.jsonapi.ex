defmodule Mix.Tasks.Phoenix.Gen.Jsonapi do
  ...
  Generates a Phoenix resource.
      ...
      mix phoenix.gen.jsonapi User users name:string age:integer
  ...
  def run(args) do
    ...
    Mix.Phoenix.copy_from paths(), "priv/templates/phoenix.gen.jsonapi", "", binding, files
  ...
  defp raise_with_help do
    Mix.raise """
    mix phoenix.gen.jsonapi expects both singular and plural names
    of the generated resource followed by any number of attributes:

        mix phoenix.gen.jsonapi User users name:string
    """
  end
