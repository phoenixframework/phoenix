  ...
  describe "parse/2" do
    ...
    test "parses CLI attribute string into %Attribute{} struct, " <>
      ...
      cli_attrs = [
        ...
        "post_id:references:table,posts:column,id:type,id",
        "author_id:references:table,users:column,id:type,binary_id:Accounts.Admin.User:on_delete,delete_all",
        "booking_id:references:table,bookings:column,id:type,id:assoc,reservation:unique",
      ...
      assert parse_cli_attrs(cli_attrs) == [
               ...
               %Attribute{
                 ...
                 options: %{
                   ...
                   association_schema: TestApp.Accounts.Admin.User
                 }
               },
               %Attribute{
                 name: :booking_id,
