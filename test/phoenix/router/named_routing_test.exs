defmodule Phoenix.Router.NamedRoutingTest do
  ...
  test "resources generates named routes for :index, :edit, :show, :new" do
    ...
    assert Router.users_path(:index) == "/users"
    assert Router.url(Router.users_path(:index, [])) == "http://example.com/users"
    assert Router.url(Router.users_path(:index)) == "http://example.com/users"
    assert Router.users_path(:edit, 123, []) == "/users/123/edit"
    assert Router.users_path(:edit, 123) == "/users/123/edit"
    assert Router.url(Router.users_path(:edit, 123, [])) == "http://example.com/users/123/edit"
    assert Router.url(Router.users_path(:edit, 123)) == "http://example.com/users/123/edit"
    assert Router.users_path(:show, 123, []) == "/users/123"
    assert Router.users_path(:show, 123) == "/users/123"
    assert Router.url(Router.users_path(:show, 123, [])) == "http://example.com/users/123"
    assert Router.url(Router.users_path(:show, 123)) == "http://example.com/users/123"
    assert Router.users_path(:new, []) == "/users/new"
    assert Router.users_path(:new) == "/users/new"
    assert Router.url(Router.users_path(:new, [])) == "http://example.com/users/new"
    assert Router.url(Router.users_path(:new)) == "http://example.com/users/new"
  end
  ...
  test "1-Level nested resources generates nested named routes for :index, :edit, :show, :new" do
    ...
    assert Router.users_comments_path(:index, 99) == "/users/99/comments"
    assert Router.url(Router.users_comments_path(:index, 99, [])) == "http://example.com/users/99/comments"
    assert Router.url(Router.users_comments_path(:index, 99)) == "http://example.com/users/99/comments"
    assert Router.users_comments_path(:edit, 88, 2, []) == "/users/88/comments/2/edit"
    assert Router.users_comments_path(:edit, 88, 2) == "/users/88/comments/2/edit"
    assert Router.url(Router.users_comments_path(:edit, 88, 2, [])) == "http://example.com/users/88/comments/2/edit"
    assert Router.url(Router.users_comments_path(:edit, 88, 2)) == "http://example.com/users/88/comments/2/edit"
    assert Router.users_comments_path(:show, 123, 2, []) == "/users/123/comments/2"
    assert Router.users_comments_path(:show, 123, 2) == "/users/123/comments/2"
    assert Router.url(Router.users_comments_path(:show, 123, 2, [])) == "http://example.com/users/123/comments/2"
    assert Router.url(Router.users_comments_path(:show, 123, 2)) == "http://example.com/users/123/comments/2"
    assert Router.users_comments_path(:new, 88, []) == "/users/88/comments/new"
    assert Router.users_comments_path(:new, 88) == "/users/88/comments/new"
    assert Router.url(Router.users_comments_path(:new, 88, [])) == "http://example.com/users/88/comments/new"
    assert Router.url(Router.users_comments_path(:new, 88)) == "http://example.com/users/88/comments/new"
  end
  ...
  test "2-Level nested resources generates nested named routes for :index, :edit, :show, :new" do
    ...
    assert Router.url(Router.users_comments_files_path(:index, 99, 1, [])) ==
    ...
    assert Router.url(Router.users_comments_files_path(:edit, 88, 1, 2, [])) ==
    ...
    assert Router.url(Router.users_comments_files_path(:show, 123, 1, 2, [])) ==
    ...
    assert Router.url(Router.users_comments_files_path(:new, 88, 1, [])) ==
  ...
  test "resources without block generates named routes for :index, :edit, :show, :new" do
    ...
    assert Router.files_path(:index) == "/files"
    assert Router.url(Router.files_path(:index, [])) == "http://example.com/files"
    assert Router.url(Router.files_path(:index)) == "http://example.com/files"
    assert Router.files_path(:edit, 123, []) == "/files/123/edit"
    assert Router.files_path(:edit, 123) == "/files/123/edit"
    assert Router.url(Router.files_path(:edit, 123, [])) == "http://example.com/files/123/edit"
    assert Router.url(Router.files_path(:edit, 123)) == "http://example.com/files/123/edit"
    assert Router.files_path(:show, 123, []) == "/files/123"
    assert Router.files_path(:show, 123) == "/files/123"
    assert Router.url(Router.files_path(:show, 123, [])) == "http://example.com/files/123"
    assert Router.url(Router.files_path(:show, 123)) == "http://example.com/files/123"
    assert Router.files_path(:new, []) == "/files/new"
    assert Router.files_path(:new) == "/files/new"
    assert Router.url(Router.files_path(:new, [])) == "http://example.com/files/new"
    assert Router.url(Router.files_path(:new)) == "http://example.com/files/new"
  end
  ...
  test "scoped route helpers generated named routes with :path, and :alias options" do
    ...
    assert Router.messages_path(:index) == "/admin/messages"
    assert Router.url(Router.messages_path(:index, [])) == "http://example.com/admin/messages"
    assert Router.url(Router.messages_path(:index)) == "http://example.com/admin/messages"
    assert Router.messages_path(:show, 1, []) == "/admin/messages/1"
    assert Router.messages_path(:show, 1) == "/admin/messages/1"
    assert Router.url(Router.messages_path(:show, 1, [])) == "http://example.com/admin/messages/1"
    assert Router.url(Router.messages_path(:show, 1)) == "http://example.com/admin/messages/1"
  end
  ...
  test "scoped route helpers generated named routes with :path, :alias, and :helper options" do
    ...
    assert Router.admin_messages_path(:index) == "/admin/messages"
    assert Router.url(Router.admin_messages_path(:index, [])) == "http://example.com/admin/messages"
    assert Router.url(Router.admin_messages_path(:index)) == "http://example.com/admin/messages"
    assert Router.admin_messages_path(:show, 1, []) == "/admin/messages/1"
    assert Router.admin_messages_path(:show, 1) == "/admin/messages/1"
    assert Router.url(Router.admin_messages_path(:show, 1, [])) == "http://example.com/admin/messages/1"
    assert Router.url(Router.admin_messages_path(:show, 1)) == "http://example.com/admin/messages/1"
  end
