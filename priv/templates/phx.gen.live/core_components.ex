defmodule <%= @web_namespace %>.CoreComponents do
  ...
  def flash_group(assigns) do
    ~H"""
    <.flash kind={:info} title={if @gettext, do: gettext("Success!"), else: "Success!"} flash={@flash} />
    <.flash kind={:error} title={if @gettext, do: gettext("Error!"), else: "Error!"} flash={@flash} />
    <.flash
      id="disconnected"
      kind={:error}
      title={if @gettext, do: gettext("We can't find the internet"), else: "We can't find the internet"}
      phx-disconnected={show("#disconnected")}
      phx-connected={hide("#disconnected")}
      hidden
    >
      <%%= if @gettext, do: gettext("Attempting to reconnect"), else: "Attempting to reconnect" %>
