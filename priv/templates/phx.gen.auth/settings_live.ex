defmodule <%= inspect context.web_module %>.<%= inspect Module.concat(schema.web_namespace, schema.alias) %>Live.Settings do
  ...
  def mount(_params, _session, socket) do
    ...
    email_changeset = <%= inspect context.alias %>.change_<%= schema.singular %>_email(<%= schema.singular %>, %{}, validate_email_uniqueness: false)
  ...
  def handle_event("validate_email", params, socket) do
    ...
    email_form =
      ...
      |> <%= inspect context.alias %>.change_<%= schema.singular %>_email(<%= schema.singular %>_params, validate_email_uniqueness: false)
