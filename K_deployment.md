...
Add our application's endpoint as a child to our application's start:
...
```text
** (RuntimeError) Something went wrong while starting endpoint: already started: #PID<0.165.0>
